...
Layout on the hub mirrors SCORING_MODELS_DIR:
  threat_contrastive_v1/ threat_v7/ distress_v3/ voice_stress_ravdess.joblib voice_metrics_ravdess.json
...
api.upload_folder(repo_id=args.repo, folder_path=args.models_dir,
                  allow_patterns=["threat_contrastive_v1/*", "threat_v7/*", "distress_v3/*", "voice_stress_ravdess.joblib",
                                  "voice_metrics_ravdess.json", "voice_feature_order_ravdess.json"],
                  ignore_patterns=["**/checkpoint-*", "**/training_args.bin"],
                  commit_message="scoring weights: threat_contrastive_v1, threat_v7, distress_v3, voice_stress_ravdess")
