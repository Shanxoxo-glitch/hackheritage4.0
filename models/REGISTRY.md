...
| threat_v7 (threat signal) | MuRIL, binary + temperature calibration | threat V7: 520 EN + Hinglish rows (synthetic V5+V6, adversarial-tested) | Shota2811/ps26094-signals `threat_v7/` | Sohon |
...
target ≥ 2,500 rows) with the contrastive objective (`training/train_threat.py --objective contrastive`); Indian-accent voice
